    ...
    certifications: [
      {
        id: 'ecocert',
        name: 'ECOCERT',
        standard: 'Organic & Natural Cosmetics',
        status: 'verified',
        ...
        supportNote: 'This certification supports natural and organic claims for cosmetics.',
      },
      {
        id: 'fsc',
        name: 'FSC',
        standard: 'Forest Stewardship Council',
        status: 'verified',
        statusLabel: 'Verified',
        statusBadge: 'Valid',
        validTill: '2026',
        ...
        supportNote: 'This certification supports sustainable forest-derived packaging claims.',
      },
    ],
    ingredients: [
      {
